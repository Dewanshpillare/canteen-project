    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">KUSHI</span> <span class="clr-green">CANTEEN</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">KUSHI</span> <span class="clr-green md">CANTEEN</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>The International Institute of Information Technology (I²IT), Pune [pronounced as I Square IT] was established by Late Shri. P. P. Chhabria, Founder Chairman of Finolex Group of Industries, a well-known philanthropist, and former President of Mahratta Chamber of Commerce, Industries and Agriculture (MCCIA). As a world-class academy to impart high-end education in Engineering and Technology the Institute has strived to meet the growing needs of the industry.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/photo/?fbid=466408638859012&set=a.466408565525686" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/p/Cr2LX7LoVVG/" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91 20 22933 441/2/3</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>admissions@isquareit.edu.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>P-14, Rajiv Gandhi Infotech Park, MIDC Phase – 1, Hinjawadi, Pune – 411057, India</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: https://www.isquareit.edu.in/it/departmental-activities</p></li>
                        </ul>
                    </article>
                </main>
                <!-- RDM Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">RDM DEVELOPERS</a></div>
                </main>
            </section>
        `;
        })
                ...
                <main class="grid grid-3">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="#" target="_blank">I2IT</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
